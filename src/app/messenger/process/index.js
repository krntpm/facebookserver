             ...
             console.info(`intent : ${responseParams['intent']}  and method : ${responseParams['method']}`);
                    ...
                    switch (intentData) {
                        ...
                        case 'transfer':
                              ...
                              text = "transfer";  
                              this.rich["Pass"] = Rich["Pass"](this.data.sender_psid,_constants.ENV.APP_ID_2);
                              
                              let serviceResponse =  new _services.responseMessenger(this.app);
                              await serviceResponse.callSendAPI('/pass_thread_control', this.rich.Pass, () => {});
                              //pass(sender_psid,_constants.ENV.APP_ID_2);
                            break;    
                        default:
